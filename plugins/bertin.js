// The svg
const svgg = d3.select(".bubblemap"),
  widthh = +svgg.attr("width"),
  heightt = +svgg.attr("height");
...
Promise.all([
  ...
  svgg
    ...
    .attr("x2", xLabel)
    .attr("y1", (d) => heightt - size(d))
    .attr("y2", (d) => heightt - size(d))
    .attr("stroke", "black")
